    ...
    <div className="flex items-center justify-center h-screen px-5">
      <div className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 md:w-1/2 w-full">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {errors.telefono && (
            <ErrorComp>{errors.telefono?.message.toString()}</ErrorComp>
          )}
          ...
          <div className="items-center justify-around text-center flex py-4 gap-2">
            <button
              className="bg-textColor rounded-md text-acentColor px-6 py-3 md:text-[.9rem] font-Onest uppercase hover:bg-acentColor hover:text-textColor"
              type="submit"
            >
              Registrar
            </button>

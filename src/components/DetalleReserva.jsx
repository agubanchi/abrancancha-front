      ...
      {showReservation ? (
        <div className="bg-white rounded-xl mx-5 my-10 px-5 py-10">
          <div className='flex items-center justify-around'>
            <div>
              <p className='text-sm uppercase font-bold mb-3 text-textColor items-center flex gap-2'> Nombre: {''}
                <span className='text-sm uppercase font-light text-textColor font-Onest'>{formData.name}</span>
              </p>
              <p className='text-sm uppercase font-bold mb-3 text-textColor items-center flex gap-2'> Email: {''}
                <span className='text-sm uppercase font-light text-textColor font-Onest'>{formData.email}</span>
              </p>
